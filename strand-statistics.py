...
try:
    ...
    import sys
    base_path = "/Users/jonasfunke/NANODESIGN/nanodesign" #os.path.abspath( os.path.join( os.path.dirname(os.path.abspath( __file__)), '../'))
...
def main():
    ...
    file_name = "/Users/jonasfunke/Dropbox/FRET_STAGE/Designs/FS-v6_spectrometer/FS-v6_009_build/FS-v6_009_02_recode_01_connected.json"
    ...
    list_of_stapleLength = [len(strand.tour) for strand in dna_structure.strands]
    #print list_of_stapleLength
    # pritn histogram
    
    
    list_of_stapleLength
    #print list_of_stapleLength
    fig, ax = plt.subplots()
    n, bins, patches = ax.hist(list_of_stapleLength, 100, normed=1)
    plt.show()
